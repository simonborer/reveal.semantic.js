...
This fork allows for the use of the `[data-slide]` attribute in place of the &lt;section&gt; element to create slides.

It always bugged me how unsemantic that was, so I fixed it.
